...
fig1 <- df |>
  ...
  scale_y_continuous(labels = scales::comma, limits = c(500, 1250), expand = c(0, 0)) +
  
  labs(y = "Prevalence rate (per 100,000 population)", x = "Year") +
...
ggsave(" figer1折线图（P）.jpeg",width = 8,height = 6,dpi = 300)